...
{
	ray[i].wallpos[0].x = (int)ray[i].raypos[0].x + ceilf(ray[i].oppose);
	ray[i].wallpos[0].y = (int)ray[i].raypos[0].y;
	ray[i].wallpos[1].x = (int)ray[i].raypos[0].x + ceilf(ray[i].oppose);
...
/* GF = [(4,4) ; (4,5)] BC = [(3.96,4.3) ; (4.4238,5.1)] FH = 4,4;4,5  */
/* t =	(p[1].x - P[3].x)(p[3].y - p[4].y) - (p[1].y - p[3].y)(P[3].x - P[4].x) */
/*    	(p[1].x - x2)(p[3].y - p[4].y) - (p[1].y - p[2].y)(P[3].x - P[4].x) */

//	t =	(4 - 3.96)(4.3 - 5.1) - (4 - 4.3)(3.96 - 4.42) = -0.17
//	  	(4 - 4)(4.3 - 5.1) - (4 - 5)(3.96 - 4.42) = -0.46
//	t = 1.08 / 0.8 = 1.35

//	u =	(p[1].x - x2)(p[1].y - p[3].y) - (p[1].y - p[2].y)(p[1].x - P[3].x)
//		-______________________________________
//		(p[1].x - x2)(p[3].y - p[4].y) - (p[1].y - p[2].y)(P[3].x - P[4].x)

//	u = (3 - 4)(5 - 4.3) - (5 - 5)(3 - 3.96) = -0.7
//		(3 - 4)(4.3 - 5.1) - (5 - 5)(3.96 - 4.42) = 0.8